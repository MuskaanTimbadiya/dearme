    ...
    <div className="min-h-screen bg-[#FDFCFB] text-[#2D2926] flex flex-col justify-between selection:bg-[#EDE8DF]">
      ...
      <header className="w-full max-w-6xl mx-auto px-6 py-8 flex items-center justify-between">
        ...
        <button
          ...
          disabled={isLoading}
          className="inline-flex items-center gap-2.5 px-6 py-2.5 rounded-full text-xs font-sans uppercase tracking-wider font-semibold bg-[#5A5A40] text-white hover:bg-[#4A4A34] active:scale-[0.98] transition-all disabled:opacity-50 cursor-pointer shadow-xs"
        >
          {isLoading ? (
      ...
      <main className="w-full max-w-4xl mx-auto px-6 py-12 flex flex-col items-center text-center">
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#F5F2ED] border border-[#E6E1D6] text-[11px] font-sans uppercase tracking-widest text-[#5A5A40] mb-8">
          <Shield className="w-3.5 h-3.5 text-[#5A5A40]" />
          <span>User-Isolated Firestore & Gemini 2.5 Intelligence</span>
        </div>

        <h2 className="text-4xl sm:text-6xl font-serif font-normal text-[#2D2926] tracking-tight leading-[1.18] mb-6 max-w-3xl">
          Deepen your daily reflections with an organic, mindful AI companion.
        </h2>

        <p className="text-base sm:text-xl text-[#5C564E] max-w-2xl mb-10 leading-relaxed font-serif italic">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4">
          <button
            ...
            onClick={handleGoogleSignIn}
            disabled={isLoading}
            className="w-full sm:w-auto inline-flex items-center justify-center gap-3 px-8 py-4 rounded-full text-sm font-sans uppercase tracking-wider font-semibold bg-[#5A5A40] text-white hover:bg-[#4A4A34] active:scale-[0.98] transition-all disabled:opacity-50 cursor-pointer shadow-md"
          >
            {isLoading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16 w-full text-left">
          <div className="p-7 rounded-[28px] bg-[#F5F2ED] border border-[#E6E1D6] shadow-xs">
